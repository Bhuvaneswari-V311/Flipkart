...
const sectionsData = [
  {
    ...
    products: [
      ...
      {
        img: "src/assets/slippers.jpg",
        alt: "slippers",
        name: "Men's Slippers",
        offer: "From ₹199",
      },
      {
        img: "src/assets/sportsshoes2.jpg",
        alt: "sports shoes",
  ...
  },
  {
    ...
    products: [
      {
        img: "src/assets/mens shirt.jpg",
        alt: "casual shirt",
        name: "Men's Casual Shirt",
        offer: "Min 50% Off",
      },
      {
        img: "src/assets/tshirts.jpg",
        alt: "tshirt",
        name: "Men's T-Shirts",
        offer: "Special Offer",
      },
      {
        img: "src/assets/saree.jpg",
        alt: "saree",
        name: "Women Saree",
        offer: "Min 40% Off",
      },
      {
        img: "src/assets/bluespeaker.jpg",
        alt: "speaker",
